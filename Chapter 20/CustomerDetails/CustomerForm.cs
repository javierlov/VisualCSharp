...
namespace CustomerDetails
{
	...
	public class CustomerForm : System.Windows.Forms.Form
	{
		...
		private void InitializeComponent()
		{
			...
			this.gender.Validating += new System.ComponentModel.CancelEventHandler(this.genderValidating);
			// 
			// female
			// 
			...
			this.title.Validating += new System.ComponentModel.CancelEventHandler(this.titleValidating);
			// 
			// lastName
			// 
		...
		private bool checkTitleAndGender()
		{
			...
			// Título y genero casan
			return true;
		}


		private void titleValidating(object sender, System.ComponentModel.CancelEventArgs e)
		{
		...
		private void genderValidating(object sender, System.ComponentModel.CancelEventArgs e)
		{
			if (!checkTitleAndGender())
			{
				e.Cancel = true;
